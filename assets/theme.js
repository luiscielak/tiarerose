...
(function($){
   ...
   * Filtering Functions
   * -----------------------------------------------------------------------------
   * A collection of functions that help with filtering operations.
   *
   */  
...
/* HC - Collection slider component - 05 Oct '20 */
window.addEventListener('DOMContentLoaded', function(){
  $('.slick-slider-hc').slick({
    slidesToShow: 4,
    infinite: false,
    nextArrow: '<button type="button" class="slick-next"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M4 .755l14.374 11.245-14.374 11.219.619.781 15.381-12-15.391-12-.609.755z"/></svg></button>',
    prevArrow: '<button type="button" class="slick-prev"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M20 .755l-14.374 11.245 14.374 11.219-.619.781-15.381-12 15.391-12 .609.755z"/></svg></button>',
    responsive: [
      {
        breakpoint: 767,
        settings: {
